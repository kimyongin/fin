...
export const requiredMutationSignatures = {
  ...
  app_save_principle_with_activity: ['input_activity_tag_ids', 'input_body', 'input_change_note', 'input_expected_body', 'input_expected_change_note', 'input_expected_row_id', 'input_principle_id'],
  ...
  app_save_allocation_targets_with_activity: ['input_activity_tag_ids', 'input_change_note', 'input_expected_targets', 'input_idempotency_key', 'input_targets'],
  app_clear_allocation_targets_with_activity: ['input_activity_tag_ids', 'input_change_note', 'input_expected_targets', 'input_idempotency_key'],
  ...
  app_save_asset_detail_with_activity: ['input_activity_tag_ids', 'input_expected', 'input_holdings', 'input_idempotency_key', 'input_instrument', 'input_instrument_id', 'input_reason'],
