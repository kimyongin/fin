...
const guideSources: Record<WorkflowGuideTopic, WorkflowGuideSource> = {
  ...
  holding_thesis: {
    ...
    boundaries: [
      'The shared instrument note is not a personal policy, allocation target, trade, or private journal. Do not put sensitive text there without explaining its existing asset-sharing scope.',
