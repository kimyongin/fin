...
const guideSources: Record<WorkflowGuideTopic, WorkflowGuideSource> = {
  ...
  reconciliation: {
    ...
    related_tools: ['list_operating_rules', 'find_holdings', 'get_holding_integrity', 'get_portfolio_integrity', 'preview_holding_reconciliation', 'reconcile_holding', 'verify_holdings', 'save_general_task'],
    source_paths: [
      'supabase/functions/_shared/mcp/portfolio-tools.ts',
      'supabase/functions/portfolio-mcp-oauth/index.ts',
