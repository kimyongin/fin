...
const guideSources: Record<WorkflowGuideTopic, WorkflowGuideSource> = {
  ...
  todo: {
    ...
    related_tools: ['list_general_tasks', 'list_due_general_tasks', 'get_general_task', 'get_activity', 'search_activities', 'list_activity_tags', 'save_general_task', 'transition_general_task', 'record_manual_activity', 'update_activity', 'delete_activity', 'set_activity_tags', 'set_general_task_tags'],
    source_paths: [
