create or replace function public.mcp_save_holding(
    input_token_hash text, input_holding_id bigint default null, input_account_id bigint default null, input_ticker text default null,
    input_quantity numeric default null, input_avg_price numeric default null, input_purchase_amount numeric default null,
    input_valuation_amount numeric default null, input_note text default null, input_request text default null
)
returns table (holding_id bigint, account_id bigint, account_name text, ticker text, display_name text, instrument_type text, quantity numeric, avg_price numeric, purchase_amount numeric, valuation_amount numeric, note text, activity_id bigint)
