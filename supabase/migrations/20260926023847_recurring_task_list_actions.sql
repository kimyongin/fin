-- Keep active recurring definitions visible in web task lists after a completed
-- occurrence or before their first due time. The due-task queue is unchanged.
