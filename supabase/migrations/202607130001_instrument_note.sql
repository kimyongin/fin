...
drop function if exists public.mcp_save_instrument(text, bigint, text, text, text, text, numeric, date, bigint, text, text);
drop function if exists public.app_save_instrument(bigint, text, text, text, text, numeric, date, bigint, text, text, text);
