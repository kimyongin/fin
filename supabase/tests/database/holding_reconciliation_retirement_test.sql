...
select extensions.ok(to_regprocedure('public.app_apply_holding_correction(bigint,jsonb,text,date,bigint,uuid,text)') is not null, 'direct correction remains available');
