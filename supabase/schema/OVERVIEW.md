...
| `app_update_entity_note` | Idempotently update only an existing account, instrument, or holding note after comparing the normalized expected note. It writes one activity event and does not change financial holding state. |
