...
- 마지막 확인한 운영 앱 기준은 [2026-09-27 배포 기록](./engineering/deployment.md)의 `0d6a0db` (#159)이다. 이후 로컬 커밋을 운영 배포로 간주하지 않는다. 실제 Google 로그인·ChatGPT 웹/모바일 확인 등 남은 항목은 배포 기록을 따른다.
