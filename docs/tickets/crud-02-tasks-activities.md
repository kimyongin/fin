...
2026-09-26 · [#152](https://github.com/kimyongin/fin/issues/152) · 설계 완료, 구현 전.
...
## 수용 조건
- [ ] 일반/반복/완료/중단 할 일 삭제, 연결 기록 보존, 삭제 후 due queue 제외.
- [ ] 기록만 삭제해도 반복 회차 완료가 유지됨.
- [ ] 필드+태그 저장의 rollback, 충돌, 재시도 및 cross-tenant 참조 거부.
- [ ] 기록/할 일/태그 각각 웹↔MCP 교차 CRUD.
- [ ] workflow guide, 호출 예제와 운영 tools/list 검증 항목 갱신.
