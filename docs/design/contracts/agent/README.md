...
2026-09-21 · 구현 진행 중. OAuth 로컬 연결과 일일 점검 4개 도구의 종단간 검증을 완료했다. 판단/할 일 7개, 개인 투자 기준 2개, 보유 이유 2개, 완료 매매 3개, 잔고 무결성 4개, 거래 취소 2개 도구는 DB와 공통 schema/handler 단위까지 검증했으며 OAuth 종단간·운영 배포·웹/모바일 전체 재검증은 아직 하지 않았다.
